...
const GallerySection = () => {
  ...
  return (
    <section className="py-12 md:py-20 bg-gradient-to-b from-black to-zinc-950" id="gallery">
      <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 md:mb-16 px-2">
          <div className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 mb-4 sm:mb-6 bg-gradient-to-r from-orange-500/10 to-red-500/10 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-orange-500/20">
            ...
            <span className="text-xs sm:text-sm md:text-base text-orange-300 font-semibold tracking-wide">
              RESTAURANT GALLERY
            </span>
          </div>
          ...
          <p className="text-sm sm:text-base md:text-xl text-gray-400 max-w-3xl mx-auto mb-6 md:mb-8 px-2">
            Step into a world where culinary excellence meets breathtaking ambiance
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-12 md:mb-20">
          {restaurantImages.map((img, index) => (
            <div 
              key={img.id}
              className="relative group overflow-hidden rounded-xl sm:rounded-2xl md:rounded-3xl border border-orange-500/30 bg-gradient-to-br from-zinc-900 to-black hover:border-orange-500/50 transition-all duration-500 shadow-lg sm:shadow-xl md:shadow-2xl shadow-orange-500/10"
              onMouseEnter={() => setActiveImage(index)}
            >
              {/* Actual Image */}
              <div className="aspect-[4/3] overflow-hidden">
              ...
              {/* Hover Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4 sm:p-6 md:p-8">
                <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                  <div className="flex items-center gap-2 mb-2 sm:mb-3">
                    <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-orange-400" />
                    <span className="text-white text-sm sm:text-base font-medium">Cafe Janoshi, Okara</span>
                  </div>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-1 sm:mb-2">{img.title}</h3>
                  <p className="text-gray-300 text-xs sm:text-sm mb-3 sm:mb-4">{img.description}</p>
                  <div className="flex items-center gap-2 sm:gap-3">
                    <button className="px-4 sm:px-6 py-1.5 sm:py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white text-sm sm:text-base rounded-lg sm:rounded-xl font-medium hover:shadow-lg hover:shadow-orange-500/30 transition-all">
                      View Details
                    </button>
                    <button className="px-3 sm:px-4 py-1.5 sm:py-2 bg-white/10 text-white rounded-lg sm:rounded-xl font-medium hover:bg-white/20 transition-all backdrop-blur-sm">
              ...
              {/* Image Title Badge */}
              <div className="absolute top-3 sm:top-4 left-3 sm:left-4 px-3 sm:px-4 py-1 sm:py-2 bg-black/80 backdrop-blur-sm rounded-lg sm:rounded-xl border border-orange-500/30">
                <h3 className="text-white font-bold text-sm sm:text-base md:text-lg truncate">{img.title}</h3>
              </div>

              {/* Image Number Indicator */}
              <div className="absolute top-3 sm:top-4 right-3 sm:right-4 px-2 sm:px-3 py-1 bg-gradient-to-r from-orange-500 to-red-500 text-white text-xs sm:text-sm font-bold rounded-full">
                {index + 1}/4
              </div>
            </div>
          ))}
        ...
        <div className="mb-12 md:mb-20">
          <div className="bg-gradient-to-br from-zinc-900 to-black rounded-xl sm:rounded-2xl md:rounded-3xl border border-orange-500/30 p-6 sm:p-8 md:p-12 shadow-xl sm:shadow-2xl">
            <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-8">
              {/* Content */}
              <div className="lg:w-2/3">
                <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-full mb-4 sm:mb-6">
                  <Award className="w-4 h-4 sm:w-5 sm:h-5 text-orange-400" />
                  <span className="text-orange-300 text-xs sm:text-sm font-bold">TOP RATED RESTAURANT</span>
                </div>
                ...
                <div className="space-y-3 sm:space-y-4 text-gray-300 mb-6 sm:mb-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-4">
                    <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 rounded-lg sm:rounded-xl border border-zinc-800">
                      <div className="p-2 sm:p-3 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg">
                        <Star className="w-5 h-5 sm:w-6 sm:h-6 text-orange-400" />
                      </div>
                      <div>
                        <div className="text-white font-bold text-lg sm:text-xl">4.9/5</div>
                        <div className="text-gray-400 text-xs sm:text-sm">500+ Reviews</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 rounded-lg sm:rounded-xl border border-zinc-800">
                      ...
                      <div>
                        <div className="text-white font-bold text-lg sm:text-xl">10,000+</div>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 rounded-lg sm:rounded-xl border border-zinc-800">
                      ...
                      <div>
                        <div className="text-white font-bold text-lg sm:text-xl">3 Years</div>
                        <div className="text-gray-400 text-xs sm:text-sm">Culinary Excellence</div>
                      </div>
                    </div>
                    
                    <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 rounded-lg sm:rounded-xl border border-zinc-800">
                      <div className="p-2 sm:p-3 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg">
                        <ThumbsUp className="w-5 h-5 sm:w-6 sm:h-6 text-orange-400" />
                      </div>
                      <div>
                        <div className="text-white font-bold text-base sm:text-lg md:text-xl">Award Winning</div>
                        <div className="text-gray-400 text-xs sm:text-sm">Best Cafe 2023</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <a 
                    href="#contact"
                    className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white text-sm sm:text-base font-bold rounded-lg sm:rounded-xl hover:shadow-xl hover:shadow-orange-500/30 transition-all"
                  >
                    Book Your Table
                  ...
                  <a 
                    href="#menu"
                    className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-zinc-800 to-zinc-900 text-gray-300 text-sm sm:text-base rounded-lg sm:rounded-xl font-medium hover:bg-gradient-to-r hover:from-zinc-700 hover:to-zinc-800 transition-all border border-zinc-800"
                  >
                    View Full Menu
                  </a>
                </div>
              ...
              <div className="lg:w-1/3 mt-6 lg:mt-0">
                <div className="bg-gradient-to-br from-amber-900 to-amber-950 rounded-xl sm:rounded-2xl border border-amber-600/30 p-4 sm:p-6 transform lg:rotate-2 hover:rotate-0 transition-transform duration-300 shadow-xl sm:shadow-2xl shadow-amber-900/30">
                  <div className="text-center mb-4 sm:mb-6">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto bg-gradient-to-br from-amber-500 to-yellow-500 rounded-full flex items-center justify-center mb-3 sm:mb-4 shadow-lg">
                      <Coffee className="w-8 h-8 sm:w-10 sm:h-10 text-amber-900" />
                    </div>
                    <h4 className="text-xl sm:text-2xl font-bold text-amber-100">Evening Tea Buffet</h4>
                    <p className="text-amber-300 text-xs sm:text-sm">Special Package • 6 PM - 10 PM</p>
                  </div>
                  
                  <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                    <div className="flex justify-between items-center p-2 sm:p-3 bg-amber-900/30 rounded-lg">
                      <span className="text-amber-200 text-xs sm:text-sm">Unlimited Tea & Coffee</span>
                      <span className="text-amber-400 font-bold">✓</span>
                    </div>
                    <div className="flex justify-between items-center p-2 sm:p-3 bg-amber-900/30 rounded-lg">
                      <span className="text-amber-200 text-xs sm:text-sm">15+ Snack Varieties</span>
                      <span className="text-amber-400 font-bold">✓</span>
                    </div>
                    <div className="flex justify-between items-center p-2 sm:p-3 bg-amber-900/30 rounded-lg">
                      <span className="text-amber-200 text-xs sm:text-sm">Live Counter Service</span>
                      <span className="text-amber-400 font-bold">✓</span>
                    </div>
                    <div className="flex justify-between items-center p-2 sm:p-3 bg-amber-900/30 rounded-lg">
                      <span className="text-amber-200 text-xs sm:text-sm">2 Hours Dining</span>
                      <span className="text-amber-400 font-bold">✓</span>
                    </div>
                  </div>
                  ...
                  <div className="text-center pt-4 border-t border-amber-800/30">
                    <div className="flex items-center justify-center gap-2 mb-1 sm:mb-2">
                      <span className="text-amber-400 text-xs line-through">Rs 1,999</span>
                      <span className="text-2xl sm:text-3xl font-bold text-amber-300">Rs 1,499</span>
                    </div>
                    <div className="text-amber-400 text-xs sm:text-sm mb-3 sm:mb-4">Per Person • 25% OFF</div>
                    <button className="w-full py-2.5 sm:py-3 bg-gradient-to-r from-amber-600 to-yellow-600 text-amber-50 text-sm sm:text-base font-bold rounded-lg hover:shadow-lg hover:shadow-amber-500/30 transition-all">
                      Book Tea Buffet
                    </button>
                  </div>
                </div>
        ...
        <div className="mb-12 md:mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {customerPhotos.map((photo) => (
              <div 
                key={photo.id}
                className="group relative overflow-hidden rounded-lg sm:rounded-xl border border-zinc-800 bg-gradient-to-br from-zinc-900 to-black hover:border-orange-500/40 transition-all duration-300 shadow-lg"
              >
                <div className="aspect-square overflow-hidden">
                  <img 
                    src={photo.image} 
                ...
                <div className="p-3 sm:p-4 bg-gradient-to-t from-black to-transparent">
                  <div className="flex items-center justify-between mb-1 sm:mb-2">
                    <h4 className="text-white font-bold text-sm sm:text-base truncate">{photo.title}</h4>
                    <div className="flex items-center gap-1">
                      <Star className="w-3 h-3 sm:w-4 sm:h-4 text-yellow-400 fill-current" />
                      <span className="text-white text-xs sm:text-sm font-bold">{photo.rating}</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Users className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400" />
                      <span className="text-gray-400 text-xs sm:text-sm">{photo.customer}</span>
                    </div>
                    <Heart className="w-4 h-4 sm:w-5 sm:h-5 text-pink-400 hover:text-pink-300 transition-colors cursor-pointer" />
                  </div>
                </div>
                
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-3 sm:p-4">
                  <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-white font-bold text-base sm:text-lg truncate">{photo.title}</h4>
                      <div className="px-2 py-1 bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded text-xs text-orange-300">
                        Verified
                      </div>
                    </div>
                    <p className="text-gray-300 text-xs sm:text-sm mb-2">"Amazing food experience at Cafe Janoshi!"</p>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-400 text-xs">Shared by {photo.customer}</span>
          ...
          <div className="text-center mt-6 sm:mt-8">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-pink-500 via-purple-500 to-orange-500 text-white text-sm sm:text-base font-bold rounded-xl hover:shadow-xl hover:shadow-pink-500/30 transition-all"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-12 md:mb-20">
          {additionalImages.map((img) => (
            <div 
              key={img.id}
              className="relative group overflow-hidden rounded-xl sm:rounded-2xl md:rounded-3xl border border-orange-500/30 bg-gradient-to-br from-zinc-900 to-black shadow-xl sm:shadow-2xl"
            >
              <div className="aspect-[16/9] overflow-hidden">
                <img 
                  src={img.image} 
              ...
              {/* Content Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent flex items-end p-4 sm:p-6 md:p-8">
                <div>
                  <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    <div className="p-2 sm:p-3 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg sm:rounded-xl backdrop-blur-sm">
                      {img.id === 1 ? (
                        <Music className="w-5 h-5 sm:w-6 sm:h-6 text-orange-400" />
                      ) : (
                        <Utensils className="w-5 h-5 sm:w-6 sm:h-6 text-orange-400" />
                      )}
                    </div>
                    <div>
                      <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white">{img.title}</h3>
                      <p className="text-gray-300 text-xs sm:text-sm">{img.description}</p>
                    </div>
                  </div>
                  <button className="mt-2 sm:mt-4 px-4 sm:px-6 py-1.5 sm:py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white text-sm sm:text-base rounded-lg sm:rounded-xl font-medium hover:shadow-lg hover:shadow-orange-500/30 transition-all">
                    Explore More
                  </button>
                </div>
              </div>
              ...
              <div className="absolute top-3 sm:top-4 left-3 sm:left-4 px-3 sm:px-4 py-1 sm:py-2 bg-black/80 backdrop-blur-sm rounded-lg sm:rounded-xl border border-orange-500/30">
                <span className="text-white font-bold text-sm sm:text-base">
                  {img.id === 1 ? 'Live Entertainment' : 'Kitchen Tour'}
                </span>
              </div>
            </div>
          ))}
        ...
        {/* Final CTA */}
        <div className="text-center">
          <div className="inline-block bg-gradient-to-br from-zinc-900 to-black rounded-xl sm:rounded-2xl md:rounded-3xl border border-orange-500/30 p-6 sm:p-8 md:p-12 max-w-3xl shadow-xl sm:shadow-2xl">
            <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-full flex items-center justify-center mb-4 sm:mb-6">
              <Star className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-orange-400" />
            </div>
            ...
            <p className="text-gray-400 mb-6 sm:mb-8 text-sm sm:text-base md:text-lg leading-relaxed px-2">
              Join thousands of satisfied customers who have made Cafe Janoshi their favorite dining destination. 
              From romantic dinners to family gatherings, we create memories that last a lifetime.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <a 
                href="#contact"
                className="px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white text-sm sm:text-base font-bold rounded-xl hover:shadow-xl hover:shadow-orange-500/30 transition-all"
              >
                📞 Book Your Table Now
              </a>
              <a 
                href="tel:03210001112"
                className="px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-zinc-800 to-zinc-900 text-gray-300 text-sm sm:text-base rounded-xl font-medium hover:bg-gradient-to-r hover:from-zinc-700 hover:to-zinc-800 transition-all border border-zinc-800"
              >
                ☎️ Call: 0321 0001112
              </a>
            </div>
