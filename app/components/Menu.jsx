...
const COMPLETE_MENU_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'smooky-chicken-wrap', name: 'Smooky Chicken Wrap', price: 749, description: 'Smoky chicken wrap', image: '/smokychickenwrap.jpg' },
      ...
      { id: 'jn-special-sauce', name: 'JN Special Sauce', price: 99, description: 'Signature sauce', image: '/jnsauce.jpg' },
      ...
      { id: 'honey-mustard-sauce', name: 'Honey Mustard Sauce', price: 99, description: 'Honey mustard', image: '/honeymustard.jpg' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'finger-mozzarella', name: 'Finger Mozzarella', price: 799, description: 'Mozzarella sticks', image: '/fingermozzarella.jpg' },
      ...
      { id: 'glazzed-wings', name: 'Glazzed Wings', price: 999, description: 'Glazed chicken wings', image: '/glazedwings.jpg' },
      ...
      { id: 'nacho-loaded-fries', name: 'Nacho Loaded Fries', price: 799, description: 'Nacho loaded fries', image: '/nachofries.jpg' },
      ...
      { id: 'spring-roll', name: 'Spring Roll', price: 699, description: 'Spring rolls', image: '/springroll.jpg' },
